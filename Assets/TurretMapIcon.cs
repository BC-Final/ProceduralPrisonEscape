...
public class TurretMapIcon : MonoBehaviour {
    public static void CreateInstance(Vector2 pPos, float rot)
    {
        GameObject go = (GameObject)Instantiate(HackerReferenceManager.Instance.TurretIcon, new Vector3(pPos.x / MinimapManager.scale, pPos.y / MinimapManager.scale, 0), Quaternion.Euler(0, rot, 0));
    }
    ...
    public void UpdateEnemy(CustomCommands.Update.TurretUpdate package)
    {
