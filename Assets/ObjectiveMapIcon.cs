...
public class ObjectiveMapIcon : AbstractMapIcon {
	public static void ProcessPacket (NetworkPacket.Update.Objective pPacket) {
	...
	private static void createInstance (NetworkPacket.Update.Objective pPacket) {
	...
	private void updateInstance (NetworkPacket.Update.Objective pPacket) {
