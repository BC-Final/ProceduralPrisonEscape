...
public class PlayerMotor : MonoBehaviour {
	...
	public void SetCanMove (bool pCanMove) {
		_canMove = pCanMove;
	...
	public void SetSlowMove (bool pSlowMove) {
		_slowMove = pSlowMove;
	}
	...
	void FixedUpdate () {
		...
		if (_canMove) {
			if (grounded) {
				...
				if (!toggleRun)
					speed = _slowMove ? slowSpeed : (Input.GetKey(KeyCode.LeftShift) ? runSpeed : walkSpeed);
	...
	void Update () {
		...
		if (toggleRun && grounded && Input.GetKeyDown(KeyCode.LeftShift))
			speed = _slowMove ? slowSpeed : (speed == walkSpeed ? runSpeed : walkSpeed);
	}
